...
server <- function(input, output, session) {
  ...
  biocircos_listen <- reactive({
    list( vals$sempi_data,vals$rre_data, vals$deep_data, vals$anti_data, vals$prism_data, input$biocircos_color,
          ...
          input$score_a, input$rename, input$reset_name, vals$arts_data, vals$prism_supp)
  })
  ...
  vals$rename_data <- read.csv(system.file("extdata", "rename.csv", package = "BGCViz"))

  observeEvent(input$anti_sco,{
    anti_data <- read.csv(system.file("extdata/example_data", "sco_antismash.csv", package = "BGCViz"))
    ...
    # Save file
    #write.csv(vals$anti_data, system.file("extdata","anti_data.csv" ,package = "BGCViz"), row.names = F)
  ...
  observeEvent(input$prism_sco,{
    # Read data
      data <- fromJSON(file = system.file("extdata/example_data", "sco_prism.json", package = "BGCViz"))
    ...
    # Save file
    #write.csv(vals$prism_data, system.file("extdata", "prism_data.csv", package = "BGCViz"), row.names = F)
  ...
  observeEvent(input$sempi_sco,{
    ...
    sempi_data <- read.csv(system.file("extdata/example_data", "sco_sempi.csv", package = "BGCViz"))
  ...
  observeEvent(input$arts_sco, {
    ...
    data <- read.delim(system.file("extdata/example_data", "sco_duptable.tsv", package = "BGCViz"))
    ...
    data <- read.delim(system.file("extdata/example_data", "sco_knownhits.tsv", package = "BGCViz"))
  ...
  observeEvent(input$deep_sco, {
    ...
    # Read data
    vals$deep_data <- read.delim(system.file("extdata/example_data", "sco_deep.tsv", package = "BGCViz")) %>%
  ...
  observeEvent(input$rre_sco, {
    # Read data
    vals$rre_data <- read.delim(system.file("extdata/example_data", "sco_rre.txt", package = "BGCViz"))
  ...
  observeEvent(input$rename, {
    ...
    if(vals$prism_data_input == T){
      prism_data <- read.csv("prism_data")
  ...
  output$barplot_rank <- renderPlotly({
    ...
    ranking_data <- rbind(antismash_count,prism_count, deep_count,rre_count, sempi_count, prism_supp_count, arts_count)
  ...
  content =  function(file){
    ...
    flst <- c(flst, system.file("extdata", "group.py" , package = "BGCViz"))
    #create the zip file from flst vector
    zip(file,  flst, extras = "-j") },
